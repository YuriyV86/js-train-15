...
function generateRandomPassword(length) {
  ...
  for (let i = 0; i <= length; i++) {
    passowrd = passowrd + characters[Math.floor(Math.random() * characters.length)];
  }
...
function calculateCircleArea(radius) {
  ...
  if (typeof radius !== 'number') {
    console.log(`Радіус має бути числом`);
    return null;
  }
...
function calculateHypotenuse(a, b) {
  ...
  if (typeof a !== 'number' || typeof b !== 'number') {
    console.log(`Довжини катетів мають бути числами`);
    return null;
  }
...
function calculateVolumeCylinder(radius, height) {
  ...
  if (typeof radius !== 'number' || typeof height !== 'number') {
    console.log(`Аргументи мають бути числами`);
    return null;
  }
...
function isTotalPriceExceedsMaxPrice(products, maxPrice) {
  ...
  if (!Array.isArray(products)) {
    console.log(`Аргумент products має бути масивом`);
    return null;
  }

  if (typeof maxPrice !== 'number') {
    console.log(`Аргумент maxPrice має бути числом`);
    return null;
  }

  let totalPrice = products.reduce((sum, x) => sum += x.price, 0);
